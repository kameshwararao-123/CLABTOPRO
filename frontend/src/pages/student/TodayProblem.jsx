        ...
        <div className="mt-6 rounded-2xl border border-slate-200 bg-white p-7 shadow-sm">
          ...
          <div className="mt-7 grid gap-5 md:grid-cols-2">
            <div>
              ...
              <pre className="mt-2 rounded-xl bg-slate-900 p-4 font-mono text-sm text-green-400 overflow-x-auto">
                {problem.sampleInput}
              </pre>
            </div>
          ...
          <button
            ...
            className={`mt-8 inline-flex items-center gap-2 rounded-xl px-6 py-3 font-semibold text-white transition ${
              problem.isSolved
